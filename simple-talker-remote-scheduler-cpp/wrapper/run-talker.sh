...
# Debug Trace
#echo "TRACE_ENABLE_STDOUT=${TRACE_ENABLE_STDOUT}"
#echo "TRACE_ENABLE_UNITS =${TRACE_ENABLE_UNITS}"

source $ROS_BASE/opt/ros/jazzy/setup.bash #source if ros2 using debian package is build as a snap
